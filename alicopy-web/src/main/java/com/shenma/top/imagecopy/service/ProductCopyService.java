...
import com.shenma.top.imagecopy.util.bean.Item;
...
public class ProductCopyService {
	...
	private void searchShopUrl(SearchVoBean bean) throws IOException, InterruptedException,NullPointerException{
		...
		if(element!=null)throw new NullPointerException("不存在该店铺");
